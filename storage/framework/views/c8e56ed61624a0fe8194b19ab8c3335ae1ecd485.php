          ...
          <div id="b0" class="bony veo info-box" alt="Banco de Leon">
               <span class="info-box-icon bg-info1 elevation-1"><i class="fa fa-university"></i></span>
                <div class="info-box-content">
                 <span class="info-box-text"><h3 class="h31"> <?php echo e($bank['code']); ?></h3></span>
                 <span class="info-box-number"> <?php echo e($bank['name']); ?> </span>
               </div>
          </div>
   ...
   <div class="form-group row rec1">
       ...
       <div class="col-md-4 col-sm-4">
           <div class="input-group">
               <input type="text" class="form-control paca rec2" name="dolarcompra" id="totaldolarcompra" value="<?php echo e($totales[$bank['name']]['total_compra_dolar']); ?>" disabled>
      ...
      <div class="form-group row rec1">
           <label for="totaldolarventa" class="control-label col-md-4 col-sm-4 rec1">Total transacciones dólar venta</label>
                 <div class="col-md-4 col-sm-4">
                     <div class="input-group">
                         <input type="text" class="form-control paca rec2" name="dolarventa" id="totaldolarventa" value="<?php echo e($totales[$bank['name']]['total_venta_dolar']); ?>" disabled>
                         <div class="input-group-append">
                              <div class="input-group-text rec2"><span class="fa fa-usd"></span></div>
                              </div>
                              </div>
      ...
      <div class="form-group row rec1">
            <label for="totaleurocompra" class="control-label col-md-4 col-sm-4 rec1">Total transacciones euro compra</label>
                  <div class="col-md-4 col-sm-4">
                      <div class="input-group">
                          <input type="text" class="form-control paca rec2 " name="eurocompra" id="totaleurocompra" value="<?php echo e($totales[$bank['name']]['total_compra_euro']); ?>" disabled>
                          <div class="input-group-append">
     ...
     <div class="form-group row rec1">
           <label for="totaleuroventa" class="control-label col-md-4 col-sm-4 rec1">Total transacciones euro venta</label>
                     <div class="col-md-4 col-sm-4">
                       <div class="input-group">
                           <input type="text" class="form-control paca rec2" name="euroventa" id="totaleuroventa" value="<?php echo e($totales[$bank['name']]['total_venta_euro']); ?>" disabled>
                           <div class="input-group-append ">
                            <div class="input-group-text rec2"><span class="fa fa-eur"></span></div>
                            </div>
                            </div>
    ...
    <div class="form-group row rec1">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="input-group">
                <input type="text" class="form-control paca rec2" name="comision" id="comision" value="<?php echo e($comision[0]['comision']); ?>">
                    <div class="input-group-append">
      ...
      <div class="form-group row rec1">
          ...
          <div class="col-md-4 col-sm-4">
              <div class="input-group">
                  <input type="text" class="form-control paca rec2" name="comision" id="comision" value="<?php echo e($comision[0]['comision_euro']); ?>">
                  <div class="input-group-append">
                      <div class="input-group-text rec2"><span class="fas fa-percentage"></span></div>
                  </div>
              </div>
    ...
    <div class="form-group row rec1">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="input-group">
                <input type="text" class="form-control paca rec2" name="totalcomision" id="totalcomision" value="<?php echo e($total_dolar_comision); ?>" disabled>
                <div class="input-group-append">
      ...
      <div class="form-group row rec1">
          ...
          <div class="col-md-4 col-sm-4">
              <div class="input-group">
                  <input type="text" class="form-control paca rec2" name="totalcomisione" id="totalcomisione" value="<?php echo e($total_euro_comision); ?>" disabled>
                  <div class="input-group-append">
                      <div class="input-group-text rec2"><span class="fa fa-money"></span></div>
                  </div>
              </div>
...
<div id="completa1">
 ...
 <table id="comple" class="table table-bordered table-hover table-striped display" style="width:100%;">
   ...
   <tbody>
       ...
       <?php $__currentLoopData = $completado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr>
               <td><?php echo e($comp['nombre']); ?></td>
               <td><?php echo e($comp['tipo_transaccion']); ?></td>
               <td><?php echo e($comp['cantidad']); ?></td>
               <td><?php echo e($comp['fecha_last_transaccion']); ?></td>
           </tr>
...
<table id="cance"  class="table table-bordered table-hover table-striped display" style="width:100%;">
    ...
    <?php $__currentLoopData = $cancelado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e($comp['nombre']); ?></td>
            <td><?php echo e($comp['tipo_transaccion']); ?></td>
            <td><?php echo e($comp['cantidad']); ?></td>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\xcomm\resources\views/reporte/reportes_usuario_basico.blade.php ENDPATH**/ ?>