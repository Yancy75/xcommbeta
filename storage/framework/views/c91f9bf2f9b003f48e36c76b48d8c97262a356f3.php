        ...
        <div class="col-md-11">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-dark by float-right" href="<?php echo e(route('listadoTransaccionesAbiertas')); ?>"><i class="fa fa-undo"></i> Volver</a>
                    <div class="clear"></div>
                </div>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xcommbeta\resources\views/xcomm/historico_transaccion.blade.php ENDPATH**/ ?>