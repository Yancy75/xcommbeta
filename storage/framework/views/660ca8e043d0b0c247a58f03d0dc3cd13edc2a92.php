        ...
        <div class="container-fluid">
           <div class="card card-default">
             <div class="card-header">
               <h3 class="card-title titulo2"><i class="nav-icon fas fa-university"></i> Cofiguracion de Bancos</h3>
               <div class="card-tools">
                ...
                <div class="card-body">
                    <input type="hidden" class="form-control" id="InputInfoPagarRutaBanco" value="<?php echo e(route('cargarInfoTipoPagoBanco')); ?>"/>
                    <h4>En efectivo</h4>
                    <form>
                ...
                <form>
                  ...
                  <div id="MensajeConfiguracionTipoDePagoBanco"></div>
                </div>
            </div>
        </div>
      </section>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rc3ezbst6wcw/public_html/resources/views/bancos/configuracion_banco.blade.php ENDPATH**/ ?>