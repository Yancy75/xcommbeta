...
<div class="modal fade" id="addUsuarioBancoModal" tabindex="-1" role="dialog" aria-labelledby="addUsuarioModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" id="formAddUsuarioBanco" action="<?php echo e(route('addUsuarioBanco')); ?>">
                <div class="modal-body">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" id="idBancoAddUsuarioBanco" name="entidadbancarias_id" value="<?php echo e(isset($banco->id)?$banco->id:''); ?>">
...
<?php /**PATH /home/rc3ezbst6wcw/public_html/resources/views/xcomm/modals/add_usuario_banco.blade.php ENDPATH**/ ?>