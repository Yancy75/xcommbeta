                      ...
                      <!--<button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>-->
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?php echo e(route('cargandoCambioDivisaBanco', ['id' => $banco->id])); ?>">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" id="valor_de_comision" value="<?php echo e($comision[0]['comision']); ?>">
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\xcomm\resources\views/bancos/cambio_divisa.blade.php ENDPATH**/ ?>