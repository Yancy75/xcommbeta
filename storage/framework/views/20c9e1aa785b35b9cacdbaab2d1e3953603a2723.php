                            ...
                            <div class="col-md-10 col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="comisione" id="comisione" placeholder="Comision..."
                                           <?php if(!empty($info)): ?>
                                           value="<?php echo e($info[0]->comision_euro); ?>"
                                        <?php endif; ?>
                                    />
                                    <div class="input-group-append">
                                        <div class="input-group-text"><span class="fas fa-percentage"></span></div>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xcommbeta\resources\views/xcomm/configuraciones.blade.php ENDPATH**/ ?>