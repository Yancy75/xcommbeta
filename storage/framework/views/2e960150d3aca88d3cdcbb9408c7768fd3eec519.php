              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post" style="font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
                  <div class="user-block">
                    <img class="img-bordered-sm" src="<?php echo e(asset('png/xcomm logo.jpg')); ?>" alt="user image">
                        <span class="username">
                          <a href="#">Concepto</a>
                        </span>
...
<?php echo $__env->make('layouts.usuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rc3ezbst6wcw/public_html/resources/views/estaticas/quees.blade.php ENDPATH**/ ?>