                                ...
                                <hr/>
                                    <div class="row">
                                        <div class="col-md-6 offset-md-11">
                                            <input type="hidden" id="id_eliminar_tasa_<?php echo e($control); ?>" value="<?php echo e(route("eliminarTasaGeneral", ['id' => $i['id']])); ?>"/>
                                            <button type="button" class="btn boton btn-danger btn-sm" onclick="eliminarTasaGenerales(<?php echo e($control); ?>, '<?php echo e($i['banco']); ?>');"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                               </div>
                              </div>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xcommbeta\resources\views/xcomm/form_tasa_general.blade.php ENDPATH**/ ?>