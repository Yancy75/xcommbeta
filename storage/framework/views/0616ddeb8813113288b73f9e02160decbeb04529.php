...
.eti{
  background: linear-gradient(45deg, #d0cdcd 10%, transparent);
  font-size: 1.5em;
}
.publico{
  background: white;
...
<div class="multiple">
  <div class="wow zoomIn caja publico" id="publicidad1" data-wow-duration="1s" data-wow-delay="1.5s">publicidad 1</div>
    ...
    <div class="card card-primary card-tabs">
             <div class="card-header p-0 pt-1">
               <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                 ...
                 <li class="nav-item">
                   <a class="nav-link" id="custom-tabs-two-profile-tab" data-toggle="pill" href="#custom-tabs-two-profile" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">¿QUE ES XCOMM?</a>
                 </li>
                 <li class="nav-item">
                   <a class="nav-link" id="custom-tabs-two-messages-tab" data-toggle="pill" href="#custom-tabs-two-messages" role="tab" aria-controls="custom-tabs-two-messages" aria-selected="false">¿COMO FUNCIONA?</a>
                 </li>
                 <li class="nav-item">
                   <a class="nav-link" id="custom-tabs-two-linea-tab" data-toggle="pill" href="#custom-tabs-two-linea" role="tab" aria-controls="custom-tabs-two-linea" aria-selected="false">¿PORQUE XCOMM?</a>
                 </li>
               </ul>
             </div>
             <div class="card-body">
  ...
  <div class="wow zoomIn caja publico" id="publicidad2" data-wow-duration="1s" data-wow-delay="1.7s">publicadad 2</div>
</div>
</section>
<script>
  $(function() {
  ...
  {
      $.ajax({
          url: "<?php echo e(route('monstrarTransaccionesDolarEuro')); ?>",
          type: 'GET',
          data: {
              data   : 'data'
          },
          dataType: 'JSON',
          success: function (d) {
              $("#dolar_transaction_total").val(d["dolar"]);
              $("#euro_transaction_total").val(d["euro"]);
          },
          error: function()
          {
...
<?php echo $__env->make('layouts.usuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\xcomm\resources\views/bienvenidos.blade.php ENDPATH**/ ?>