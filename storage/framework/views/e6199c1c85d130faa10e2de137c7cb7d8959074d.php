<?php $__env->startSection('content'); ?>
   ...
   <style>
    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="bota">
                <a href="<?php echo e(route('verTransaccionesClientes', ['id_cliente' => $id_cliente])); ?>" class="btn boton btn-primary"><i class="far fa-folder-open"></i> Transacciones Abiertas</a>
                <a href="<?php echo e(route('verTransaccionesClientesCompletadas', ['id_cliente' => $id_cliente])); ?>" class="btn boton btn-success"><i class="far fa-check-circle"></i> Transacciones Completadas</a>
                <a href="<?php echo e(route('verTransaccionesClientesCanceladas', ['id_cliente' => $id_cliente])); ?>" class="btn boton btn-danger"><i class="far fa-window-close"></i> Transacciones Canceladas</a>
            </div>
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn boton btn-secondary float-right" href="<?php echo e(route('clientesDashboard')); ?>"><i class="fa fa-reply" aria-hidden="true"></i> Volver</a>
                    <div class="clear"></div>
                </div>
                    ...
                    <table id="transaccion"  class="table table-bordered table-hover table-striped">
                        ...
                        <?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('verHistorico', ['id_transaccion' => $inf->id])); ?>" class="btn boton btn-primary"><i class="fa fa-eye"></i> Ver</a></td>
                            </tr>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xcomm\resources\views/xcomm/transacciones_clientes.blade.php ENDPATH**/ ?>