    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <input type="hidden" id="id_ruta_transaccion_bancaria" value="<?php echo e(route('add_transaccion')); ?>">
                    <input type="hidden" id="id_ruta_cancelar_transaccion_bancaria" value="<?php echo e(route('cancelar_transaccion_cliente')); ?>">
                ...
                <div id="idUploadFileDiv" style="margin-bottom: 15px;margin-top:10px;">
                    <button type="button" onclick="monstrarUploadFile();" class="btn btn-danger boton"><i class="far fa-file"></i> Subir archivo</button>
                </div>
...
<?php /**PATH /home/rc3ezbst6wcw/public_html/resources/views/clientes/modals/venta_dolar.blade.php ENDPATH**/ ?>