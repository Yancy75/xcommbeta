  ...
  <ol class="breadcrumb">
    ...
    <br/>
        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter diseno">
            <img src="<?php echo e(asset('png/descarga.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter contador">
            <img src="<?php echo e(asset('png/descarga2.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter diseno">
            <img src="<?php echo e(asset('png/modelo.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter administrador">
            <img src="<?php echo e(asset('png/modelo2.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter ingeniero">
            <img src="<?php echo e(asset('png/modelo3.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter administrador">
            <img src="<?php echo e(asset('png/modelo4.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter ingeniero">
            <img src="<?php echo e(asset('png/oficina1.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter administrador">
            <img src="<?php echo e(asset('png/oficina2.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter administrador">
            <img src="<?php echo e(asset('png/oficina3.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter diseno">
            <img src="<?php echo e(asset('png/oficina4.jpg')); ?>" class="img-responsive">
        </div>

        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter ingeniero">
            <img src="<?php echo e(asset('png/oficina5.jpg')); ?>" class="img-responsive">
        </div>
...
<?php echo $__env->make('layouts.componente.cabecera_inv', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('layouts.usuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rc3ezbst6wcw/public_html/resources/views/estaticas/personal.blade.php ENDPATH**/ ?>