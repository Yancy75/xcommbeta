  ...
  <div class="row">
    <span class="col-md-7">
       <ul class="baseul">
         ...
         <li class="mail"><i class="fa fa-envelope"></i><a href="<?php echo e(route('contactos')); ?>"> info@accapla.com</a></li>
      </ul>
    </span>
...
<?php /**PATH C:\laragon\www\xcommbeta\resources\views/layouts/componente/minicabe.blade.php ENDPATH**/ ?>