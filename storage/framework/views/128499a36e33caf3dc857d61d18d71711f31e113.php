...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-center">
          <div class="col-md-12">
            <div class="bota">
                <a href="<?php echo e(route('listadoTransaccionesAbiertas')); ?>" class="btn boton btn-primary"><i class="far fa-folder-open"></i> Transacciones Abiertas</a>
                <a href="<?php echo e(route("listadoTransaccionesCerradas")); ?>" class="btn boton btn-success"><i class="far fa-check-circle"></i> Transacciones Cerradas</a>
                <a href="<?php echo e(route("listadoTransaccionesCanceladas")); ?>" class="btn boton btn-danger"><i class="far fa-window-close"></i> Transacciones Canceladas</a>
            </div>
            <div class="card">
                    ...
                    <table id="transacciones" class="table table-striped table-bordered" style="width: 100%; font-size: 0.9rem">
                        ...
                        <?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('verHistorico', ['id_transaccion' => $in->id_transaccion_good])); ?>" class="btn boton btn-primary"><i class="fa fa-eye"></i> Ver</a></td>
                            </tr>
...
<?php echo $__env->make('layouts.appusuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xcommbeta\resources\views/xcomm/transacciones_abiertas.blade.php ENDPATH**/ ?>