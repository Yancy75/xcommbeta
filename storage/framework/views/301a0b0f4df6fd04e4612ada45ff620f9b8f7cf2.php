        ...
        <div class="modal-content">
            ...
            <form method="POST" id="formModifyUsuarioBanco" action="">
                <div class="modal-body">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="idBancoModifyUsuarioBanco" name="entidadbancarias_id" value="<?php echo e(isset($banco->id)?$banco->id:''); ?>">
...
<?php /**PATH /home/rc3ezbst6wcw/public_html/resources/views/xcomm/modals/modify_usuario_banco.blade.php ENDPATH**/ ?>